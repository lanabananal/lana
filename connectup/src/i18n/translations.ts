...
const translations = {
  en: {
    nav: {
      ...
      language: 'Language',
      services: 'Career',
      comunicacaoProfissional: 'Professional Communication',
      cvLinkedin: 'CV & LinkedIn',
      financeiro: 'Financial Planning',
      planejamentoInternacional: 'International Financial Planning',
      planejamentoFiscal: 'Tax Planning in Paraguay',
    },
    hero: {
      badge: '360° Professional Mobility',
      headline: 'Global minds',
      headline2: 'connect.',
      subheadline:
        'We turn technical expertise into global authority. ConnectUP offers a 360° solution for professional mobility — removing barriers of communication, tax bureaucracy, and market positioning to open the path to a truly global and financially independent career.',
  ...
  pl: {
    nav: {
      ...
      language: 'Język',
      services: 'Kariera',
      comunicacaoProfissional: 'Komunikacja Zawodowa',
      cvLinkedin: 'CV & LinkedIn',
      financeiro: 'Planowanie Finansowe',
      planejamentoInternacional: 'Międzynarodowe Planowanie Finansowe',
      planejamentoFiscal: 'Planowanie Podatkowe w Paragwaju',
    },
    hero: {
      badge: 'Mobilność Zawodowa 360°',
      headline: 'Global minds',
      headline2: 'connect.',
      subheadline:
        'Przekształcamy techniczny potencjał w globalny autorytet. ConnectUP oferuje rozwiązanie 360° dla zawodowej mobilności — usuwając bariery komunikacji, biurokracji podatkowej i pozycjonowania rynkowego, otwierając drogę do prawdziwie globalnej i niezależnej finansowo kariery.',
      cta: 'Rozpocznij globalną podróż',
  ...
  es: {
    nav: {
      ...
      language: 'Idioma',
      services: 'Carrera',
      comunicacaoProfissional: 'Comunicación Profesional',
      cvLinkedin: 'CV & LinkedIn',
      financeiro: 'Planificación Financiera',
      planejamentoInternacional: 'Planificación Financiera Internacional',
      planejamentoFiscal: 'Planificación Fiscal en Paraguay',
    },
    hero: {
      badge: 'Movilidad Profesional 360°',
      headline: 'Global minds',
      headline2: 'connect.',
      subheadline:
        'Transformamos el potencial técnico en autoridad global. ConnectUP ofrece una solución 360° para la movilidad profesional, eliminando las barreras de la comunicación, la burocracia fiscal y el posicionamiento de mercado, abriendo el camino hacia una actuación verdaderamente global y financieramente independiente.',
      cta: 'Inicia tu camino global',
